...
print("\n")
nfa = {} 
print("Enter the following inputs to form NFA table :")
print("\n")                             

n = int(input("No. of states : "))            #Enter total no. of states
t = int(input("No. of input symbols : "))       #Enter total no. of transitions/paths eg: a,b so input 2 for a,b,c input 3
...
print("NFA for the given input is:\n")
print("\nNFA :- \n")
